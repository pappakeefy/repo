...
base='http://www.pappakeefy.com'
ADDON=xbmcaddon.Addon(id='plugin.video.KeefyWizard')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/o129j5pcj1hiq51/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Keefy Wizard","Downloading ",'', 'Geez a Minute')
    ...
    time.sleep(2)
    dp.update(0,"", "Opening Zip Geez another minute, eh?")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("DOWNLOAD COMPLETE", 'The only way to get the new changes to save is', 'to force close kodi. Click OK to force Kodi to close,', 'DO NOT use the quit/exit options in Kodi., If the Force close does not close, please Restart Device or kill the task manaully')
    killxbmc()
